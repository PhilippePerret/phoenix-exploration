...
#
# SUR ALWAYSDATA, NE PAS OUBLIER DE COCHER LA CASE "Exclure le chemin"
# DANS LA PARTIE "AVANCÉ" DE LA CONFIGURATION
#
...
config :swoosh, api_client: Swoosh.ApiClient.Finch, finch_name: Exploration.Finch
